...
Original file is located at
    https://colab.research.google.com/drive/13cV29N4xYwKdkMX3vlQ92e1VR_iLo_TM
"""
...
def multimodal_concat_model(
    ...
    # ----- Fusion -----
    concat = Concatenate(name="concat_features")([t1_feat, t2_feat, img_feat, meta_feat])
    x = Dense(128, activation="relu", name="fusion_fc")(concat)
    out = Dense(n_class, activation="softmax", name="final_softmax")(x)

    model = Model(
        inputs=[inp_meta, inp_t1, inp_t2, inp_img],
        outputs=out,
        name="MultiModalSimpleConcat"
    )
    return model
...
if __name__ == "__main__":
    ...
    model = multimodal_concat_model(dummy_meta, maxlen, im_size, n_class=2)
    model.summary()

model = multimodal_concat_model(
    data_meta=data_meta,
...
import os
out_dir = "/content/drive/MyDrive/mm_experiments/run_concat"
